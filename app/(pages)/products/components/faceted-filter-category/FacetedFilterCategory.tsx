...
interface FacetedFilterCategoryProps<TData, TValue> {
...
export default function FacetedFilterCategory<TData, TValue>({ column, title, options }: FacetedFilterCategoryProps<TData, TValue>) {
