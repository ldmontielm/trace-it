...
export default function ContentWarehouses() {
    ...
    if (isLoading) {
        return (
            <div className='border p-4 flex flex-col text-center items-center justify-center'>
                ...
                <h3 className='font-extrabold text-xl mb-1'>Cargando Álmacenes</h3>
                <p className='text-muted-foreground text-sm'>Estamos cargando la información relacionado con los álmacenes.</p>
            </div>
        );
    }
    if (isError) {
        return (
            <div className='border mt-10 p-4 flex flex-col text-center items-center justify-center'>
                ...
                <h3 className='font-extrabold text-xl mb-1'>Error En Álmacenes</h3>
                <p className='text-muted-foreground text-sm'>Ha ocurrido un error al cargar los álmacenes.</p>
            </div>
        );
    }
    return (
        <div className='space-y-5'>
            <div className='space-y-5'>
                ...
                <div>
                    <DatatableCard columns={columns} table={table} />
                </div>
            </div>
        </div>
    )
